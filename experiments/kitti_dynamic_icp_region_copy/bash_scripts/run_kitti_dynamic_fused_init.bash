...
config_path="${CONFIG_PATH:-$code_path/experiments/kitti_dynamic_icp_region_copy/configs/kitti/lsgslam_dynamic_fused_init.py}"
step="${STEP:-50}"
sequence=""
start=""
end=""
...
for ((i=start; i<=end; i+=step)); do
    ...
    output_dir="$code_path/experiments/kitti_dynamic_icp_region_copy/outputs/kitti/fused_init/$sequence/$run_name"
