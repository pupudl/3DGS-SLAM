...
config = dict(
    workdir=os.path.join("experiments", "kitti_dynamic_icp_region_copy", "outputs", "kitti", "optimized_pose"),
    ...
    dynamic=dict(
        ...
        icp_corr_threshold=0.5,
        residual_thresh_m=1.0,
        unmatched_penalty=2.0,
        enable_lidar_icp=True,
        lidar_icp_corr_threshold=0.5,
        lidar_residual_thresh_m=1.0,
        lidar_unmatched_penalty=2.0,
        lidar_max_points=120000,
        lidar_min_forward_m=0.0,
        lidar_max_forward_m=0.0,
        search_radius_px=1,
        pixel_stride=2,
