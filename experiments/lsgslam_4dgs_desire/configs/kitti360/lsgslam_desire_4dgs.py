...
group_name = "kitti360-0000-desire-4dgs"
...
config = dict(
    ...
    dynamic_mask=dict(
        ...
        rigidmask=dict(
            ...
            calibration_path=os.path.join(DATA_ROOT, "kitti360", "calibration", "perspective.txt"),
    ...
    desire_4dgs=dict(
        ...
        separate_velocity=10.0,
        lambda_v_reg=0.01,
        velocity_loss_scale=10.0,
    ),
    sky_mask=dict(
        enabled=True,
        backend="mmseg_segformer",
        mask_root="",
        dataset_basedir=os.path.join(DATA_ROOT, "kitti360", "data_2d_raw"),
