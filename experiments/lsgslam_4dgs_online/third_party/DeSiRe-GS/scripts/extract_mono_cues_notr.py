...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', type=str, default='./data/notr/')
    parser.add_argument('--seq_list', type=str, default=['084'], help='specify --seq_list if you want to limit the list of seqs')
    ...
    for scene_i, scene_id in enumerate(tqdm(select_scene_ids, f'Extracting {args.task} ...')):
        ...
        image_dir = os.path.join(args.data_root, scene_id, f"{args.rgb_dirname}")
