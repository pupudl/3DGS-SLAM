...
config = dict(
    ...
    lidar_motion_probe=dict(
        ...
        nonground_filter_method="plane",
        nonground_min_y_m=-3.0,
        nonground_max_y_m=1.35,
        ground_distance_threshold_m=0.18,
        ground_candidate_y_percentile=45.0,
        ground_fit_max_points=50000,
        ground_min_candidate_points=1000,
        ground_min_abs_normal_y=0.65,
        ground_ransac_n=3,
        ground_num_iterations=200,
        residual_nn_max_points=60000,
        residual_vis_max_m=1.5,
    ),
    sky_mask=dict(
        enabled=True,
