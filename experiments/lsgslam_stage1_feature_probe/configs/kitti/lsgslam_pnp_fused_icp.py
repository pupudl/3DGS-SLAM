...
group_name = "kitti00-pnp-fused-icp"
...
config = dict(
    ...
    use_grad_mask=False,
    opt_local_map=False,
    opt_current_frame=False, # Current-frame refinement updates only rgb_colors
    use_wandb=False,
    ...
    sky_mask=dict(
        ...
        mask_root="/home/qiuyu/data/Projects/LSG-SLAM/data/kitti/sky_masks",
        dataset_basedir="/home/qiuyu/data/Projects/LSG-SLAM/data/kitti/sequences",
