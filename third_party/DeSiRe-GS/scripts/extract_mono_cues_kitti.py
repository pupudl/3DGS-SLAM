...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', type=str, default='./data/kitti_mot/training')
    parser.add_argument('--seq_list', type=str, default=['0001', '0002', '0006'], help='specify --seq_list if you want to limit the list of seqs')
    ...
    select_scene_ids = [f'{args.rgb_dirname}_02', f'{args.rgb_dirname}_03']

    
    for scene_i, scene_id in enumerate(tqdm(select_scene_ids, f'Extracting {args.task} ...')):
        for seq in args.seq_list:
            image_dir = os.path.join(args.data_root, scene_id, seq)
